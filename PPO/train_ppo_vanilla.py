...
def train():
    ...
    agent = PPOVanilla(env.observation_space.shape[0], env.action_space.n)
    recorder = Recorder(env, "ppo_vanilla_lander.mp4")
    episode_rewards = []
    ...
    plt.xlabel("Episode")
    plt.ylabel("Reward")
    plt.title("Vanilla PPO on LunarLander-v2")
    plt.savefig("reward_ppo_vanilla.png")
    plt.close()
    np.save("rewards_vanilla.npy", episode_rewards)
